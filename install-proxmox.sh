...
pct exec "$CTID" -- sh -c "cat > /data/config.json << 'JSON'
{
  ...
  \"miner\":   { \"host\": \"\", \"api_key\": \"\" },
  \"control\": { \"enable_start_soc\": false, \"start_soc_percent\": 80,
                \"enable_start_battery_charge\": false, \"start_battery_charge_watt\": 2000,
                \"enable_pause_soc\": false, \"pause_soc_percent\": 30,
                \"enable_pause_battery_discharge\": false,
                \"pause_battery_discharge_watt\": 300,
                \"enable_pause_grid_import\": false, \"pause_grid_import_watt\": 300,
                \"start_stable_minutes\": 5, \"stop_stable_minutes\": 0 },
  ...
  \"mode\":    { \"active\": \"auto\" },
  \"modes\":   { \"manual_override\": \"auto\", \"pending_override\": null,
